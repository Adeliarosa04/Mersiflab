...
<div class="page-title">
    <h1>Add Free Course</h1>
</div>

<div class="card-content">
    <div class="card-content-title">
        <span>Create New Free Course</span>
    ...
    <form action="{{ route('admin.free-classes.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        @include('admin.free-classes.partials.form')

        <div class="d-flex justify-content-end gap-2">
            <a href="{{ back_url(route('admin.free-classes.index')) }}" class="btn btn-secondary">Cancel</a>
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save me-1"></i>Create Free Course
            </button>
        </div>
    </form>
</div>
